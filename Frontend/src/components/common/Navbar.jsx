    ...
    <div className="max-w-screen-2xl container mx-auto md:px-20 px-4">
      <div className="navbar bg-base-100">
        <div className="navbar-start">
          ...
          <a className="text-3xl gap-0 font-bold cursor-pointer">
            Rent<span className="text-blue-500">It</span>
          </a>
        </div>
        <div className="navbar-center hidden lg:flex">
          <ul className="menu menu-horizontal px-3 text-2xl font-semibold space-x-6">
            {navItems}
          </ul>
        </div>
        <div className="navbar-end flex justify-around items-center">
          <div>
